...
public class UserGroupInfoProvider extends ContentProvider {
	private final static String AUTHORITH = "com.huawei.hunandx.auth.provider";//content:// com.huawei.hunandx.auth.provider/authinfo
	private final static String PATH = "/authinfo";//groupinfo
	private final static String PATHS = "/authinfo/#";//groupinfo/#
