...
public class SharedPreferencesUtil {
	...
	public static void setStringValue(Context context,String key,String vaule){
		SharedPreferences sp = getSp(context);
		PutData(key, vaule, sp);
	}

	private static void PutData(String key, String vaule, SharedPreferences sp) {
		Editor edit=sp.edit();
	...
	public static float getFloatValue(Context context,String key,float defaultVaule) {
		SharedPreferences sp = getSp(context);
		float result = 0;
		if (null!=sp) {
	...
	public static long getLongValue(Context context,String key,long defaultVaule) {
		SharedPreferences sp = getSp(context);
		long result = 0;
		if (null!=sp) {
